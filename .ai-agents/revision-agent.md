...
Protect the official Unity & Hope identity and existing functionality. Before editing, inspect the current Git state and the exact files in scope. Preserve routing, responsiveness, form delivery, review moderation, private Blob content/submissions, admin authentication, SEO metadata, accessibility and the Vercel configuration.
