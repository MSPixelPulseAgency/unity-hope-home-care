...
**Project:** Unity Hope Home Care
**Generated:** 2026-08-09 14:20:19
...
|------|-----|--------------|
| Primary | `#30105B` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#461273` | `--color-secondary` |
| Accent/CTA | `#D59A19` | `--color-accent` |
| Background | `#FFF9ED` | `--color-background` |
| Foreground | `#21182A` | `--color-foreground` |
| Muted | `#F8F4FB` | `--color-muted` |
| Border | `#EADFF1` | `--color-border` |
...
**Style:** Premium trust-first home care, derived from the supplied Unity & Hope brochure and approved homepage.

**Keywords:** Elegant serif, warm home photography, deep purple, restrained gold, cream, senior-friendly, compassionate.

**Best For:** Non-medical home care, family trust, lead generation, service education.

**Key Effects:** Curved purple and gold transitions, selective glass surfaces, soft card lift, brief reveal motion.
